        ...
        <div class="relative z-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div class="max-w-3xl">
            ...
            <p class="mt-3 text-sm leading-6 opacity-85">
              ...
              quota-controlled and runs a temporary math-only agent so the tunnel and budgeting flow
    ...
    <Card v-if="!canUseAgent" class="border border-amber-500/30 bg-amber-500/10 shadow-lg mb-6">
      <template #content>
        ...
        <p class="mt-2 text-sm leading-6 opacity-85">
          This page is available only to admins and operators because all requests spend tokens from
          a shared builder account.
        </p>
      </template>
    </Card>
          ...
          <Card class="shadow-lg">
            <template #content>
              ...
              <div class="space-y-3 text-sm leading-6 opacity-85">
                ...
                <p>
                  The current server route is already separated from the page through a stable API,
                  so swapping in the final predefined agent is a backend change rather than a UI
                  rewrite.
                </p>
              </div>
            </template>
          ...
          <Card class="shadow-lg">
            <template #content>
              ...
              <div class="flex flex-wrap gap-2 mb-3">
                ...
                <Tag
                  :severity="agentMode.provider === 'copilot-sdk-auth-ready' ? 'info' : 'secondary'"
